...
from accounts.views import UserSignUp, sign_out_view, UserSignIn, Profile, ProfileEdit, delete_profile_view

urlpatterns = (
    path('<int:pk>', Profile.as_view(), name='profile'),
    path('profile_edit/<int:pk>', ProfileEdit.as_view(), name='edit profile'),
